...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2023 at 11:54 AM
...
--
-- Table structure for table `users_has_cerita`
--

CREATE TABLE `users_has_cerita` (
  `idusers` varchar(40) NOT NULL,
  `idcerita` int(11) NOT NULL,
...
--
-- Indexes for table `users_has_cerita`
--
ALTER TABLE `users_has_cerita`
...
--
-- Constraints for table `users_has_cerita`
--
ALTER TABLE `users_has_cerita`
